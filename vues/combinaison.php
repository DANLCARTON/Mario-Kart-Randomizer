...
function afficheSet($n) {
    ...
    <div id='result'>
        <div class='element'>
            <img src='./img/personnages/Mario.webp' id='personnage$n' alt='' />
            <p class='name'>Mario</p>
        </div>
        <div class='element'>
            <img src='./img/karts/Kart Standard.webp' id='kart$n' alt='' />
            <p class='name'>Kart Standard</p>
        </div>
        <div class='element'>
            <img src='./img/roues/Roues Standard.webp' id='roue$n' alt='' />
            <p class='name'>Roues Standard</p>
        </div>
        <div class='element'>
            <img src='./img/ailes/Aile Standard.webp' id='aile$n' alt='' />
